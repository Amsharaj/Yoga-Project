        ...
        <motion.nav
            ...
            <div className='lg:w[95%] mx-auto sm:px-6 lg:px-6'>
                        ...
                        <div className='flex'>
                            <ul className='ml-10 flex items-center space-x-4 pr-4 '>
                                ...
                                {/* user is present */}
                                {
                                    ...
                                    </li>) : (<li><NavLink to='/login' className={({ isActive }) =>
                                        `font-bold ${isActive ? 'text-secondary' : `${navBg.includes('bg-transparent') ?
                                            'text-white' : 'text-black dark:text-white'}`} hover:text-secondary duration-30`
                                    }> Login</NavLink>
                                    </li>
                                ...
                                {
                                    user && <li>
                                        <img src={user?.photoURL} alt='' className='h-[40px] rounded-full w-[40px]' />
                                    </li>
                                }
                ...
                <AnimatePresence>
                    {isMobileMenuOpen && (
                        <motion.div
                            className="md:hidden mt-2 w-full h-full bg-black"
                        ...
                        >
                            ...
                            {
                                user && <li><NavLink className='font-bold px-3 py-2 bg-secondary text-white rounded-md' onClick={handleLogout}>Logout</NavLink></li>
                            }
